...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'AgentFlow is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'AgentFlow is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'AgentFlow is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'AgentFlow is compacting the conversation...',
  },
  idle: {
