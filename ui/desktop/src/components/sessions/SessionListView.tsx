...
const i18n = defineMessages({
  ...
  importNostrDesc: { id: 'sessions.importNostr.description', defaultMessage: 'Paste an AgentFlow Nostr share link to fetch, decrypt, and import the session.' },
  ...
  chatHistoryDesc: { id: 'sessions.chatHistoryDesc', defaultMessage: 'View and search your past conversations with AgentFlow. {shortcut} to search.' },
