...
https://docs.agentflow.website/docs/troubleshooting  

📦 To help us debug faster, attach your **diagnostics zip** if possible.  
👉 How to capture it: https://docs.agentflow.website/docs/troubleshooting/diagnostics-and-reporting/
...
`;
      ...
      window.open(`https://github.com/lnlockly/agentflow-goose/issues/new?${params.toString()}`, '_blank');
      onClose();
    } catch {
      toastError({
