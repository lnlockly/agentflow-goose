...
export const getChannelInfo = <ThrowOnError extends boolean = false>(options: Options<GetChannelInfoData, ThrowOnError>) => (options.client ?? client).get<GetChannelInfoResponses, GetChannelInfoErrors, ThrowOnError>({ url: '/sessions/{session_id}/channel', ...options });

export const sendSuggestion = <ThrowOnError extends boolean = false>(options: Options<SendSuggestionData, ThrowOnError>) => (options.client ?? client).post<SendSuggestionResponses, SendSuggestionErrors, ThrowOnError>({
...
export const getSuggestions = <ThrowOnError extends boolean = false>(options: Options<GetSuggestionsData, ThrowOnError>) => (options.client ?? client).get<GetSuggestionsResponses, GetSuggestionsErrors, ThrowOnError>({ url: '/sessions/{session_id}/channel/suggestions', ...options });
