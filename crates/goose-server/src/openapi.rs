...
#[openapi(
    paths(
        ...
        super::routes::session::get_channel_info,
        super::routes::session::send_suggestion,
        super::routes::session::get_suggestions,
    ...
    components(schemas(
        ...
        super::routes::session::ChannelSuggestRequest,
        super::routes::session::ChannelInfoResponse,
        super::routes::session::SuggestionResponse,
